  ...
  configs: [
    %{
      ...
      files: %{
        ...
        #
        included: ["lib/", "src/", "web/", "apps/", "test/**/*.ex"],
        excluded: [~r"/_build/", ~r"/deps/", "test/**/*_test.{ex,exs}"]
      },
      #
      ...
      checks: [
        ...
        {Credo.Check.Consistency.MultiAliasImportRequireUse, priority: :low, exit_status: 0},
